...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("magi.hsluv")
    if color ~= "NONE" then
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/magi-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, magi.Cache
