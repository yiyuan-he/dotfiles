...
function M.setup()
  ...
  vim.g.colors_name = "monokai-pro-dark"
  ...
  -- Search & Selection
  hl("Search", { fg = p.background, bg = p.accent3 })
  hl("IncSearch", { fg = p.background, bg = p.accent2 })
  hl("CurSearch", { fg = p.background, bg = p.accent2 })
  hl("Visual", { bg = p.dimmed4 })
  hl("VisualNOS", { bg = p.dimmed4 })
  ...
  -- Diff
  hl("DiffAdd", { bg = "#3d4725" })
  hl("DiffChange", { bg = "#3d3520" })
  hl("DiffDelete", { fg = p.accent1, bg = "#55292e" })
  hl("DiffText", { bg = "#4d4520" })
  ...
  hl("DiagnosticVirtualTextError", { fg = p.accent1, bg = "#55292e" })
  hl("DiagnosticVirtualTextWarn", { fg = p.accent3, bg = "#4d4520" })
  hl("DiagnosticVirtualTextInfo", { fg = p.accent5, bg = "#2a3d40" })
  hl("DiagnosticVirtualTextHint", { fg = p.accent4, bg = "#3d4725" })

  -- Syntax
  hl("Comment", { fg = p.dimmed3, italic = true })
  ...
  hl("SpecialComment", { fg = p.dimmed3, italic = true })
